export default function ProductMaster() {
    return (
        <div>Product Master (Catalog)
            <br />
            <ul>
                <li>Variant Matrix — Size × Color × Material with auto-SKU generation</li>
                <li>Bundles &amp; Kits — "Gift set" = 1 shirt + 1 mug, deducts components</li>
